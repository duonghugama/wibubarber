        ...
        children: [
          ...
          Scaffold(
            ...
            appBar: AppBar(
              title: AutoSizeText(
                style.isNotEmpty
                    ? style + (color.isNotEmpty ? " + nhuộm: $color" : "")
                    : (color.isNotEmpty ? "Nhuộm màu: $color" : "Chọn dịch vụ"),
                maxLines: 3,
              ),
              bottom: TabBar(
                tabs: [
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      setState(() {
                                        ...
                                        style =
                                            styleSelected != -1 ? state.styles![index].styleName ?? "" : "";
                                      });
                                    },
                                    child: Card(
                                              ...
                                              child: Container(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      Text(
                                                        (state.styles![index].styleName ?? "").toUpperCase(),
                                                        style: whiteText,
                                                      ),
                                                      Text(
